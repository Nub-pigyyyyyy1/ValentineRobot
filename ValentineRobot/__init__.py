...
import spamwatch
import aiohttp
from ValentineRobot.services.quoteapi import Quotly
...
LOGGER = logging.getLogger("[ValentineRobot]")
...
telethn = TelegramClient("Valentine", API_ID, API_HASH)
pbot = Client("ValentineRobotpbot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from ValentineRobot.modules.helper_funcs.handlers import (CustomCommandHandler,
...
REDIS_URL = "redis://yoshikage:yoshikage~7@redis-11612.c240.us-east-1-3.ec2.cloud.redislabs.com:11612"
