...
from ValentineRobot import dispatcher
from ValentineRobot.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler
from ValentineRobot.modules.redis.afk_redis import start_afk, end_afk, is_user_afk, afk_reason
from ValentineRobot import REDIS
from ValentineRobot.modules.users import get_user_id

from ValentineRobot.modules.helper_funcs.alternate import send_message
from ValentineRobot.modules.helper_funcs.readable_time import get_readable_time
...
def afk(update, context):
    ...
    try:
        update.effective_message.reply_video(
            AFKVID,caption="hush! {}'s finally gone".format(fname))
    except BadRequest:
        pass
    ...
    if res:
        ...
        try:
            options = [
                ...
                "Hey {}, you were gone for {}, pls go back again!",
                "{} Came Back After Masturbating! Time Taken: {}",
                "Welcome Back {}! You Were Missing Since {} ",
            ]
