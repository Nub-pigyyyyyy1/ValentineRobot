...
from ValentineRobot.modules.helper_funcs.decorators import Valentinecmd, Valentinemsg
...
@Valentinecmd(command="antichannel", group=100)
...
@Valentinemsg(Filters.chat_type.groups, group=110)
