...
from ValentineRobot import DEV_USERS, DRAGONS, dispatcher
from ValentineRobot.modules.helper_funcs.decorators import Valentinecallback
...
@Valentinecallback(pattern="anoncb")
