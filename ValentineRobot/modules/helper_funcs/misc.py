...
from ValentineRobot import NO_LOAD
    ...
    if len(pairs) > 3:
        pairs = pairs[modulo_page * 6 : 6 * (modulo_page + 1)] + [
            (
                ...
                EqInlineKeyboardButton("Back", callback_data="Valentine_back"),
                EqInlineKeyboardButton(
        ...
        pairs += [[EqInlineKeyboardButton("Back", callback_data="Valentine_back")]]
