...
def get_user_list(config, key):
    with open('{}/ValentineRobot/{}'.format(os.getcwd(), config),
              'r') as json_file:
...
class Config(object):
    ...
    OWNER_USERNAME = "awoo"
    SUPPORT_CHAT = 'CrusadersTechSupport'  #Your own group for support, do not add the @
    ...
    BAN_STICKER = ''  # banhammer sticker id, the bot will send this sticker before banning or kicking a user in chat.
