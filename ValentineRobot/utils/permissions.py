...
from ValentineRobot import pbot as app
from ValentineRobot import DRAGONS, DEV_USERS, WOLVES, DEMONS, TIGERS
from ValentineRobot.utils.adminperms import member_permissions
