...
from motor.motor_asyncio import AsyncIOMotorClient as MongoClient
    ...
    DONATION_LINK = getenv('DONATION_LINK', "https://t.me/kira_yoshikage_789")
    ...
    SUPPORT_CHAT = getenv('SUPPORT_CHAT', "https://t.me/kakashi_bots_support")
    SPAMWATCH_SUPPORT_CHAT = getenv('SPAMWATCH_SUPPORT_CHAT', "")
    SPAMWATCH_API = getenv('SPAMWATCH_API', " ")
    REPOSITORY = getenv("REPOSITORY", "https://github.com/Yoshikage1/ValentineRobot")
    ...
    TELEGRAPH_SHORT_NAME = getenv("TELEGRAPH_SHORT_NAME", "kira")
    HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", "")
    BOT_NAME = getenv("BOT_NAME", "Valentine") # Name Of your Bot.4
    BOT_USERNAME = getenv("BOT_USERNAME", "ValentineRobot") # Bot Username
    ...
    REDIS_URL = getenv("REDIS_URL", "") # REDIS URL (From:- Heroku & Redis)
